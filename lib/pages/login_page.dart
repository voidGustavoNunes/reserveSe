...
import 'package:reservese/cadastro_page.dart';
import 'package:reservese/login_restaurante_page.dart';
                ...
                child: TextButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const LoginRestaurantePage(), // Página de Login de Restaurante
                      ),
                    );
                  },
                  child: const Padding(
